 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">知識問答平台</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('*questions/create') ? 'class="active"' : '') }}>
                            <a href="{{ url ('questions/create') }}"><i class="fa fa-edit fa-fw"></i> 新增題目</a>
                        </li>
                        <li {{ (Request::is('*questions/show') ? 'class="active"' : '') }}>
                            <a href="{{ url ('questions/show') }}"><i class="fa fa-table fa-fw"></i> 所有題目</a>
                        </li>
